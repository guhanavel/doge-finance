from dropdown import  read_csv, lookup, gen, su , summary, earnings, news_api, load_data
import dash
...
NASQ = read_csv(r"C:\Users\Asus\OneDrive\Desktop\ML\stocks\constituents_csv.csv")
opt = lookup(NASQ)
...
def ear(value,values):
    if values is None:
        ...
        fin.rename(columns={'date': 'Date', 'actual': 'Actual', 'estimate': 'Estimate', 'revenue':'Revenue', 'earnings':'Earnings'}, inplace=True)
